...
CREATE TABLE IF NOT EXISTS "orcamento" (
  ...
  "sindico_condominio_id" INT NOT NULL,
  PRIMARY KEY ("id", "sindico_id", "sindico_condominio_id"),
  CONSTRAINT "fk_orcamento_sindico1"
    FOREIGN KEY ("sindico_id" , "sindico_condominio_id")
    REFERENCES "sindico" ("id" , "condominio_id")
    ON DELETE RESTRICT
    ON UPDATE RESTRICT
);
...
CREATE TABLE IF NOT EXISTS "item_financa"(
  ...
  "valor" REAL,
  "descricao" TEXT,
  PRIMARY KEY("id","orcamento_id","tipo_financa_id"),
...
INSERT INTO "orcamento" ("id", "sindico_id", "sindico_condominio_id") VALUES (0, 0, 0);
...
INSERT INTO "tipo_financa" ("nome", "descricao", "is_renda") VALUES ("Gasto", "", 0);
INSERT INTO "tipo_financa" ("nome", "descricao", "is_renda") VALUES ("Renda", "", 1);
